            ...
            @foreach($tickets as $ticket)
                <div class="m-2 h-auto w-[400px] bg-white border border-gray-200 shadow dark:bg-off-white dark:border-gray-700 items-center text-center">
                    ...
                    <div class="">
                        ...
                        <a href="{{ route('tickets.show', $ticket->id) }}" class="my-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-full hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-black-300 dark:bg-french-grey dark:hover:bg-cool-grey dark:focus:ring-black-800">Bekijk Ticket</a>
                    </div>
                </div>
            @endforeach
        </div>
